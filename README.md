...
- [ ] Explain what a token is used for.
    To verify the user of the website is authorized and what permissions they will be allowed on the website.
    Usually issued by the server it is a string of cryptic text.
- [ ] What steps can you take in your web apps to keep your data secure?
    Implement Client Side Authentication using the url request and coding it in there to “authorize”
- [ ] Describe how web servers work.
    Web servers are basically home for requests to get to the source code.
    The original code can be stored on a computer or a program that runs on a computer. 
    So web servers are told to retrieve code when the end user requests it on a main server like a  search engine.
